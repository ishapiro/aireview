        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (__props.review.ai_generated) {
              _push2(`<div class="absolute top-2 right-2 bg-blue-600 text-white px-2 py-1 rounded text-sm"${_scopeId}><i class="pi pi-robot mr-1"${_scopeId}></i> AI Review </div>`);
            } else {
              _push2(`<!---->`);
            }
...
//# sourceMappingURL=ReviewCard-Bj3er6gZ.mjs.map
