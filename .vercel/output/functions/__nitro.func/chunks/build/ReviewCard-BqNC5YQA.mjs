...
import { mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card review-card no-underline" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (!__props.review.is_published) {
              _push2(`<div class="no-underline bg-blue-600 text-white px-2 py-1 rounded text-sm"${_scopeId}><i class="pi pi-file-edit mr-1"${_scopeId}></i> DRAFT </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="flex items-center gap-2"${_scopeId}><h3 class="text-xl font-semibold text-gray-900 mb-2"${_scopeId}>${ssrInterpolate(__props.review.title)}</h3></div>`);
            ...
            if (__props.review.ai_generated) {
              _push2(`<div class="absolute top-2 right-2 bg-blue-600 text-white px-2 py-1 rounded text-sm"${_scopeId}><i class="pi pi-robot mr-1"${_scopeId}></i> AI AugmentedReview </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><p class="text-gray-600 mb-4 line-clamp-3"${_scopeId}>${ssrInterpolate((_a = __props.review.content) == null ? void 0 : _a.substring(0, 200))}...</p><div class="flex items-center justify-between"${_scopeId}><div class="flex items-center"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "relative" }, [
                !__props.review.is_published ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "no-underline bg-blue-600 text-white px-2 py-1 rounded text-sm"
                }, [
                  createVNode("i", { class: "pi pi-file-edit mr-1" }),
                ...
                __props.review.ai_generated ? (openBlock(), createBlock("div", {
                  key: 2,
                  class: "absolute top-2 right-2 bg-blue-600 text-white px-2 py-1 rounded text-sm"
                }, [
                  createVNode("i", { class: "pi pi-robot mr-1" }),
                  createTextVNode(" AI AugmentedReview ")
                ])) : createCommentVNode("", true)
              ]),
...
//# sourceMappingURL=ReviewCard-BqNC5YQA.mjs.map
